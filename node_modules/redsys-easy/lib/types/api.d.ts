...
export declare type CommonRawResponseParams = Pick<BaseOutputParams, 'Ds_Order'>;
export declare type CommonRawRequestParams = Pick<BaseInputParams, 'DS_MERCHANT_ORDER'>;
 ...
 */
export declare type ResponseJSON = ResponseJSONSuccess | ResponseJSONError;
/**
